...
def select_roi_fullscreen(root: tk.Tk, title: str = "选择检测区域 ROI") -> Optional[RoiRel]:
    """
    Fullscreen drag-to-select ROI. Returns RoiRel (0..1) or None if cancelled.
    Must be called from tkinter thread.
    """
    ...
    tip = canvas.create_text(
        screen_w // 2,
        30,
        text="拖拽框选 ROI 区域（按 ESC 取消，按 Enter 确认）",
        fill="white",
